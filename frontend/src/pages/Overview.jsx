...
const Overview = () => {
  ...
  const animateDonutChart = (targetData) => {
    ...
    const targetCompletedPercent = total > 0 ? Math.round((completed / total) * 100) : 0;
    ...
    const step = (timestamp) => {
      ...
      const completedPercent = Math.floor(
        progress * (targetCompletedPercent - currentCompleted) + currentCompleted
      );
  ...
  useEffect(() => {
    ...
    animateValue(document.getElementById('completed-percent'), completedPercent, 800, true);
    animateValue(document.getElementById('inComplete-percent'), inCompletePercent, 800, true);
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4">
            <div className="flex-shrink-0">
              ...
              <div className="relative w-[200px] h-[200px] sm:w-[225px] sm:h-[225px]">
                ...
                <div className="absolute top-1/2 left-1/2 w-[130px] h-[130px] sm:w-[150px] sm:h-[150px] 
        ...
        <div className="grid grid-cols-1 font-poppins gap-3 max-w-md mx-auto">
          <div className="flex items-center bg-white rounded-lg inset-shadow-sm shadow-md p-3 sm:p-4">
            ...
            <div className="flex items-center justify-between w-full">
              ...
              <p id="summary-total" className="text-[18px] sm:text-[20px] text-[#A7A7A7] font-reg">
                {loading ? '...' : '0'}
              </p>
            </div>
          </div>
          <div className="flex items-center bg-white rounded-lg inset-shadow-sm shadow-md p-3 sm:p-4">
            ...
            <div className="flex items-center justify-between w-full">
              ...
              <p id="summary-completed" className="text-[18px] sm:text-[20px] text-[#A7A7A7] font-reg">
                {loading ? '...' : '0'}
              </p>
            </div>
          </div>
          <div className="flex items-center bg-white rounded-lg inset-shadow-sm shadow-md p-3 sm:p-4">
            ...
            <div className="flex items-center justify-between w-full">
              ...
              <p id="summary-inComplete" className="text-[18px] sm:text-[20px] text-[#A7A7A7] font-reg">
                {loading ? '...' : '0'}
              </p>
            </div>
          </div>
