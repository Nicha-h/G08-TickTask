...
`), o = o.replace(/\\r/g, "\r")), r[i] = o;
    ...
    var Vf = {};
    tr(Vf, { DMMF: () => lt, Debug: () => N, Decimal: () => ve, Extensions: () => ei, MetricsClient: () => Fr, PrismaClientInitializationError: () => T, PrismaClientKnownRequestError: () => z10, PrismaClientRustPanicError: () => le, PrismaClientUnknownRequestError: () => j, PrismaClientValidationError: () => Z, Public: () => ri, Sql: () => oe, createParam: () => Sa, defineDmmfProperty: () => Oa, deserializeJsonResponse: () => Tr, deserializeRawResult: () => Yn, dmmfToRuntimeDataModel: () => zs, empty: () => Na, getPrismaClient: () => fu, getRuntime: () => qn, join: () => _a, makeStrictEnum: () => gu, makeTypedQueryFactory: () => Da, objectEnumValues: () => Sn, raw: () => eo, serializeJsonQuery: () => Dn, skip: () => On, sqltag: () => ro, warnEnvConflicts: () => hu, warnOnce: () => ot });
...
`);
    ...
    var Jt = k(require("os"));
    var De = /* @__PURE__ */ Symbol.for("@ts-pattern/matcher");
    var Qu = /* @__PURE__ */ Symbol.for("@ts-pattern/isVariadic");
...
Env vars from ${Y(l)} overwrite the ones from ${Y(a)}
    ...
    x(z10, "PrismaClientKnownRequestError");
...
`);
    ...
    function $r({ error: e, user_facing_error: r }, t, n) {
      return r.error_code ? new z10(cm(r, n), { code: r.error_code, clientVersion: t, meta: r.meta, batchRequestIdx: r.batch_request_idx }) : new j(e, { clientVersion: t, batchRequestIdx: r.batch_request_idx });
    }
    function cm(e, r) {
      let t = e.message;
...
`);
    ...
    function Za({ result: e, modelName: r, args: t, extensions: n, runtimeDataModel: i, globalOmit: o }) {
      return n.isEmpty() || e == null || typeof e != "object" || !i.models[r] ? e : $n({ result: e, args: t ?? {}, modelName: r, runtimeDataModel: i, visitor: (a, l, u) => {
        let c = Se(l);
        return Ya({ result: a, modelName: c, select: u.select, omit: u.select ? void 0 : { ...o?.[c], ...u.omit }, extensions: n });
      } });
    }
    ...
    function tl(e, r, t, n = 0) {
      return e._createPrismaPromise((i) => {
        ...
        return "transaction" in r && i !== void 0 && (r.transaction?.kind === "batch" && r.transaction.lock.then(), r.transaction = i), n === t.length ? e._executeRequest(r) : t[n]({ model: r.model, operation: r.model ? r.action : r.clientMethod, args: el(r.args ?? {}), __internalParams: r, query: (s, a = r) => {
...
`;
    ...
    async function Ft(e, r) {
      ...
      if (n.type === "QueryEngineError") throw new z10(n.body.message, { code: n.body.error_code, clientVersion: r });
    ...
    var Qr = class {
      ...
      async transaction(r, t, n) {
        ...
        if (wf(a)) {
          ...
          throw l ? l.error : new z10(a.message, { code: a.error_code, clientVersion: this.config.clientVersion, meta: a.meta });
    ...
    var zn = class {
      ...
      constructor(r, t) {
        this.logEmitter = t, this.client = r, this.dataloader = new Kn({ batchLoader: il(async ({ requests: n, customDataProxyFetch: i }) => {
          ...
          let i = n.transaction?.kind === "itx" ? Zl(n.transaction) : void 0, o = await this.client._engine.request(n.protocolQuery, { traceparent: this.client._tracingHelper.getTraceParent(), interactiveTransaction: i, isWrite: Oo(n.protocolQuery.action), customDataProxyFetch: n.customDataProxyFetch });
      ...
      handleRequestError({ error: r, clientMethod: t, callsite: n, transaction: i, args: o, modelName: s, globalOmit: a }) {
        ...
        if (n && (l = bn({ callsite: n, originalMethod: t, isPanic: r.isPanic, showColors: this.client._errorFormat === "pretty", message: l })), l = this.sanitizeMessage(l), r.code) {
          ...
          throw new z10(l, { code: r.code, clientVersion: this.client._clientVersion, meta: u, batchRequestIdx: r.batchRequestIdx });
        } else {
...
var require_prisma = __commonJS({
  "src/generated/prisma/index.js"(exports2) {
    ...
    Prisma2.PrismaClientKnownRequestError = PrismaClientKnownRequestError3;
    Prisma2.PrismaClientUnknownRequestError = PrismaClientUnknownRequestError3;
    Prisma2.PrismaClientRustPanicError = PrismaClientRustPanicError2;
    Prisma2.PrismaClientInitializationError = PrismaClientInitializationError3;
    ...
    exports2.Prisma.Task_categoryScalarFieldEnum = {
      TaskID: "TaskID",
      CategoryId: "CategoryId"
    };
    exports2.Prisma.Pomodoro_sessionsScalarFieldEnum = {
      SessionId: "SessionId",
      UserID: "UserID",
      Status: "Status",
      StartTime: "StartTime",
    ...
    exports2.Prisma.Pomodoro_taskScalarFieldEnum = {
    ...
    exports2.IconType = exports2.$Enums.IconType = {
      preset: "preset",
      custom: "custom"
    };
    exports2.PomoStatus = exports2.$Enums.PomoStatus = {
      active: "active",
      paused: "paused",
      completed: "completed"
    };
    exports2.TimerType = exports2.$Enums.TimerType = {
      work: "work",
      short: "short",
      long: "long"
    };
    ...
    if (!fs.existsSync(path.join(__dirname, "schema.prisma"))) {
      ...
      config9.dirname = path.join(process.cwd(), alternativePath);
      config9.isBundled = true;
    }
    ...
    defineDmmfProperty2(exports2.Prisma, config9.runtimeDataModel);
    config9.engineWasm = void 0;
    config9.compilerWasm = void 0;
    var { warnEnvConflicts: warnEnvConflicts2 } = require_library();
    warnEnvConflicts2({
      rootEnvPath: config9.relativeEnvPaths.rootEnvPath && path.resolve(config9.dirname, config9.relativeEnvPaths.rootEnvPath),
      schemaEnvPath: config9.relativeEnvPaths.schemaEnvPath && path.resolve(config9.dirname, config9.relativeEnvPaths.schemaEnvPath)
    });
    var PrismaClient9 = getPrismaClient2(config9);
    exports2.PrismaClient = PrismaClient9;
...
// src/modules/models/Category.model.ts
var import_prisma = __toESM(require_prisma(), 1);
var dotenv = __toESM(require("dotenv"), 1);

// src/modules/middlewares/Category.validators.ts
var import_zod = require("zod");
var Category = import_zod.z.object({
  Category_Name: import_zod.z.string().min(1, { message: "Category name is required" }),
  Category_Color: import_zod.z.string(),
  Category_Icon: import_zod.z.string(),
  Category_is_Primary: import_zod.z.boolean()
});
...
var InternalServerError = class extends BaseError {
  ...
  toJSON() {
    return {
      ...
      message: this.message,
      statusCode: this.statusCode,
      ...env_default.nodeEnv === "development" && { stack: this.stack }
    };
  }
};
...
var createResponseSchema = (dataSchema) => import_zod_openapi.z.object({
  success: import_zod_openapi.z.boolean(),
  data: dataSchema,
  message: import_zod_openapi.z.string().optional(),
...
var errorResponseSchema = import_zod_openapi.z.object({
  ...
  error: import_zod_openapi.z.object({
    ...
    message: import_zod_openapi.z.string(),
    statusCode: import_zod_openapi.z.number()
  }),
  timestamp: import_zod_openapi.z.string()
});
var successResponse = (schema, description) => ({
  content: {
...
var createGetRoute = (config9) => (0, import_zod_openapi.createRoute)({
  method: "get",
  path: config9.path,
  summary: config9.summary,
  ...config9.tags && { tags: config9.tags },
  ...config9.middleware && { middleware: config9.middleware },
  ...config9.operationId && { operationId: config9.operationId },
  request: {
    ...config9.params && { params: config9.params },
    ...config9.query && { query: config9.query }
  },
  responses: {
    200: successResponse(config9.responseSchema, "Success"),
    400: commonErrors[400],
    404: commonErrors[404],
    500: errorResponse("Internal Server Error")
  }
});
var createPostRoute = (config9) => (0, import_zod_openapi.createRoute)({
  method: "post",
  path: config9.path,
  summary: config9.summary,
  ...config9.tags && { tags: config9.tags },
  ...
  request: {
    ...
    body: {
      content: {
        "application/json": { schema: config9.requestSchema }
      }
    }
  },
  responses: {
    200: successResponse(config9.responseSchema, "Success"),
    201: successResponse(config9.responseSchema, "Created"),
    400: commonErrors[400],
    404: commonErrors[404],
...
var createPutRoute = (config9) => (0, import_zod_openapi.createRoute)({
  method: "put",
  path: config9.path,
  summary: config9.summary,
  ...config9.tags && { tags: config9.tags },
  ...
  responses: {
    200: successResponse(config9.responseSchema, "Updated"),
    400: commonErrors[400],
    404: commonErrors[404],
    500: errorResponse("Internal Server Error")
  }
});
var createDeleteRoute = (config9) => (0, import_zod_openapi.createRoute)({
  method: "delete",
  path: config9.path,
  summary: config9.summary,
  ...config9.tags && { tags: config9.tags },
  ...
  responses: {
    200: successResponse(import_zod_openapi.z.null(), "Deleted"),
    400: commonErrors[400],
    404: commonErrors[404],
    500: errorResponse("Internal Server Error")
  }
...
// src/modules/schemas/task.schema.ts
var import_zod2 = require("zod");
var taskIdParam = import_zod2.z.object({
  taskId: import_zod2.z.coerce.number().int().positive()
});
var taskStatsSchema = import_zod2.z.object({
  total: import_zod2.z.number().int().nonnegative(),
  completed: import_zod2.z.number().int().nonnegative(),
  inComplete: import_zod2.z.number().int().nonnegative()
});
var TaskStatusEnum = import_zod2.z.enum(["Incomplete", "Completed"]);
var taskSchema = import_zod2.z.object({
  Task_Title: import_zod2.z.string().min(2).max(255),
  Task_Description: import_zod2.z.string().max(1e3).optional().default(""),
  Task_Start_Date: import_zod2.z.string().default(() => (/* @__PURE__ */ new Date()).toISOString().split("T")[0]),
  Task_End_Date: import_zod2.z.string().default(() => (/* @__PURE__ */ new Date()).toISOString().split("T")[0]),
  Task_Start_Time: import_zod2.z.string().default(() => (/* @__PURE__ */ new Date()).toTimeString().split(" ")[0]),
  Task_End_Time: import_zod2.z.string().default("23:59:00"),
  Task_Icon: import_zod2.z.string().max(255).default("iconWork.svg"),
  Task_Status: import_zod2.z.enum(["Incomplete", "Completed"]).default("Incomplete"),
  Task_Color: import_zod2.z.string().max(255).optional().default("#D1F4FF")
});
var TasksSchema = import_zod2.z.array(taskSchema);
var createTaskSchema = taskSchema.extend({
  UserID: import_zod2.z.coerce.number().int().positive()
});
var updateTaskSchema = taskSchema.partial().extend({
  Task_Title: import_zod2.z.string().min(2).max(255),
  Task_Description: import_zod2.z.string().max(1e3).optional().default(""),
  Task_Start_Date: import_zod2.z.string().default(() => (/* @__PURE__ */ new Date()).toISOString().split("T")[0]),
  Task_End_Date: import_zod2.z.string().default(() => (/* @__PURE__ */ new Date()).toISOString().split("T")[0]),
...
var getTasksByDateRoute = createGetRoute({
  path: "/tasks/date",
  summary: "Get tasks by date for the authenticated user",
  query: import_zod2.z.object({
    date: import_zod2.z.string().datetime()
  }),
  responseSchema: import_zod2.z.array(taskSchema),
  tags: ["Tasks"],
  middleware: [authMiddleware]
});
var getAllTasksRoute = createGetRoute({
  path: "/tasks",
...
var getTaskOverviewRoute = createGetRoute({
...
var createTaskRoute = createPostRoute({
  path: "/tasks",
...
var updateTaskRoute = createPutRoute({
  path: "/tasks/{TaskID}",
...
var deleteTaskRoute = createDeleteRoute({
  path: "/tasks/{TaskID}",
...
// src/modules/schemas/category.schema.ts
var import_zod3 = require("zod");
var removeCategoryParamsSchema = import_zod3.z.object({
  taskId: import_zod3.z.coerce.number().int().positive()
});
var removeCategoryResponseSchema = import_zod3.z.object({
  success: import_zod3.z.boolean(),
  message: import_zod3.z.string()
});
var assignCategoryRequestSchema = import_zod3.z.object({
  TaskID: import_zod3.z.coerce.number().int().positive(),
  categoryId: import_zod3.z.coerce.number().int().positive()
});
var assignCategoryResponseSchema = import_zod3.z.object({
  success: import_zod3.z.boolean(),
  message: import_zod3.z.string()
});
var categoryIdParam = import_zod3.z.object({
  categoryId: import_zod3.z.coerce.number().int().positive()
});
var userCategoryParam = import_zod3.z.object({
  categoryId: import_zod3.z.coerce.number().int().positive(),
  userId: import_zod3.z.coerce.number().int().positive()
});
var categorySchema = import_zod3.z.object({
  Category_Name: import_zod3.z.string().min(2).max(100),
  Category_Color: import_zod3.z.string().max(255).optional(),
  Category_icon: import_zod3.z.string().max(255).optional(),
  Category_is_Primary: import_zod3.z.boolean().optional()
});
var CreateCategorySchema = import_zod3.z.object({
  Category_Name: import_zod3.z.string().min(2).max(100),
  Category_Color: import_zod3.z.string().max(255).optional().default("#A7A7A7"),
  Category_icon: import_zod3.z.string().max(255).optional(),
  Category_is_Primary: import_zod3.z.boolean().optional().default(true)
});
var UpdateCategorySchema = import_zod3.z.object({
  CategoryId: import_zod3.z.coerce.number().int().positive(),
  Category_Name: import_zod3.z.string().min(2).max(100).optional(),
  Category_Color: import_zod3.z.string().max(255).optional(),
  Category_icon: import_zod3.z.string().max(255).optional(),
  Category_is_Primary: import_zod3.z.boolean().optional()
});
var deleteCategorySchema = import_zod3.z.object({
  categoryId: import_zod3.z.coerce.number().int().positive()
});
var userSchema = import_zod3.z.object({
  userId: import_zod3.z.coerce.number().int().positive()
});
var getAllCategoryRoute = createGetRoute({
  path: "/category/{userId}",
  summary: "Get all categories for the authenticated user",
  params: userSchema,
  responseSchema: import_zod3.z.array(categorySchema),
  tags: ["Categories"],
  middleware: [authMiddleware]
});
var getTaskByCategoriesRoute = createGetRoute({
  path: "/category/{categoryId}",
  summary: "Get all categories for the authenticated user",
  params: categoryIdParam,
  responseSchema: import_zod3.z.array(TaskSchemas.taskSchema),
  tags: ["Categories"],
  middleware: [authMiddleware]
});
var getCategoryProgressRoute = createGetRoute({
  path: "/category/progress/{categoryId}",
  summary: "Get category progress for the authenticated user",
  params: userCategoryParam,
  responseSchema: import_zod3.z.array(import_zod3.z.number()),
  tags: ["Categories"],
  middleware: [authMiddleware]
});
var assignTaskToCategoryRoute = createPostRoute({
...
var removeTaskFromCategoryRoute = createDeleteRoute({
...
var getTaskCountByCategoryRoute = createGetRoute({
  path: "/category/task-count/{userId}",
  summary: "Get task count by category for the authenticated user",
  params: userSchema,
  responseSchema: import_zod3.z.array(import_zod3.z.object({
    CategoryId: import_zod3.z.number().int().positive(),
    TaskCount: import_zod3.z.number().int().nonnegative()
  })),
  tags: ["Categories"],
  middleware: [authMiddleware]
});
var createCategoryRoute = createPostRoute({
  path: "/category/{userID}",
...
var updateCategoryRoute = createPutRoute({
  path: "/category/{categoryId}",
...
var deleteCategoryRoute = createDeleteRoute({
  path: "/category/{categoryId}",
...
// src/modules/schemas/user.schema.ts
var import_zod4 = require("zod");
var checkEmailRequestSchema = import_zod4.z.object({
  User_Email: import_zod4.z.string().email("Invalid email format")
});
var checkEmailResponseSchema = import_zod4.z.object({
  exists: import_zod4.z.boolean(),
  message: import_zod4.z.string().optional(),
  error: import_zod4.z.string().optional()
});
var loginRequestSchema = import_zod4.z.object({
  User_Email: import_zod4.z.string().email("Invalid email format"),
  User_Password: import_zod4.z.string().min(1, "Password is required")
});
var loginResponseSchema = import_zod4.z.object({
  message: import_zod4.z.string(),
  token: import_zod4.z.string().optional(),
  user: import_zod4.z.object({
    userId: import_zod4.z.number().int().positive(),
    // Updated strictly to Int to match Prisma
    User_Email: import_zod4.z.string().email()
  }).optional()
});
var userIdParam = import_zod4.z.object({
  userId: import_zod4.z.coerce.number().int().positive()
});
var profileSChema = import_zod4.z.object({
  Username: import_zod4.z.string().min(2).max(100),
  User_profile_icon_type: import_zod4.z.enum(["preset", "custom"]).default("preset"),
  User_profile_icon_path: import_zod4.z.string().max(255).optional()
});
var userSchema2 = import_zod4.z.object({
  UserID: import_zod4.z.coerce.number().int().positive(),
  User_Email: import_zod4.z.string().email(),
  User_Password: import_zod4.z.string().min(7)
});
var safeUserSchema = userSchema2.omit({ User_Password: true });
var userProfileSchema = import_zod4.z.object({
  user: safeUserSchema,
  profile: profileSChema
});
var resetPasswordRequestSchema = import_zod4.z.object({
  token: import_zod4.z.string({ error: "Reset token is required" }),
  newPassword: import_zod4.z.string().min(7, "Password must be at least 7 characters")
});
var resetPasswordResponseSchema = import_zod4.z.object({
  success: import_zod4.z.boolean().optional(),
  message: import_zod4.z.string().optional(),
  error: import_zod4.z.string().optional()
});
var getUserProfileRoute = createGetRoute({
...
var fetchProfileRoute = createGetRoute({
  path: "/users/{userId}/profile",
...
var updateProfileRoute = createPutRoute({
  path: "/users/{userId}/profile",
...
var uploadProfilePicRoute = createPostRoute({
  path: "/users/{userId}/profile/picture/upload",
  summary: "Upload user profile picture",
  params: userIdParam,
  requestSchema: import_zod4.z.object({
    file: import_zod4.z.instanceof(File).openapi({
      type: "string",
      format: "binary",
...
var createUserRoute = createPostRoute({
  path: "/users",
  summary: "Create a new user",
  requestSchema: userSchema2,
  responseSchema: userProfileSchema,
  tags: ["Users"]
});
var checkEmailRoute = createPostRoute({
...
var resetPasswordRoute = createPostRoute({
...
var loginUserRoute = createPostRoute({
  path: "/auth/login",
...
// src/modules/schemas/pomodoro.schema.ts
var import_zod5 = require("zod");
var TimerTypeEnum = import_zod5.z.enum(["work", "short", "long"]);
var SessionStatusEnum = import_zod5.z.enum(["active", "paused", "completed"]);
var sessionSchema = import_zod5.z.object({
  SessionId: import_zod5.z.number(),
  UserID: import_zod5.z.number(),
  Status: SessionStatusEnum,
  StartTime: import_zod5.z.string(),
  EndTime: import_zod5.z.string().nullable().optional(),
  PausedTime: import_zod5.z.string(),
  duration_seconds: import_zod5.z.number(),
  remaining_seconds: import_zod5.z.number(),
  timer_type: TimerTypeEnum,
  last_updated: import_zod5.z.string().datetime()
});
var createSessionSchema = import_zod5.z.object({
  UserID: import_zod5.z.number().int().positive(),
  duration_seconds: import_zod5.z.number().int().positive().default(1500),
  timer_type: TimerTypeEnum.optional()
});
var updateSessionSchema = import_zod5.z.object({
  status: SessionStatusEnum.optional(),
  remaining_seconds: import_zod5.z.number().int().nonnegative().optional(),
  timer_type: TimerTypeEnum.optional()
});
var startSessionSchema = import_zod5.z.object({
  userId: import_zod5.z.number().int().positive(),
  duration_seconds: import_zod5.z.number().int().positive().default(1500),
  timer_type: TimerTypeEnum.optional()
});
var pauseSessionSchema = import_zod5.z.object({
  sessionId: import_zod5.z.number().int().positive()
});
var updateRemainingTimeSchema = import_zod5.z.object({
  remaining_seconds: import_zod5.z.number().int().nonnegative()
});
var userIdParam2 = import_zod5.z.object({
  userId: import_zod5.z.coerce.number().int().positive()
});
var sessionIdParam = import_zod5.z.object({
  sessionId: import_zod5.z.coerce.number().int().positive()
});
var getAllSessionsRoute = createGetRoute({
  path: "/sessions/user/{userId}",
  summary: "Get all sessions for a user",
  params: userIdParam2,
  responseSchema: import_zod5.z.array(sessionSchema),
  tags: ["Sessions"],
  middleware: [authMiddleware],
  operationId: "getAllSessions"
});
var getActiveSessionRoute = createGetRoute({
...
var getSessionByIdRoute = createGetRoute({
  path: "/sessions/{id}",
...
var createSessionRoute = createPostRoute({
  path: "/sessions",
...
var updateSessionRoute = createPutRoute({
  path: "/sessions/{id}",
...
var deleteSessionRoute = createDeleteRoute({
  path: "/sessions/{id}",
...
var startSessionRoute = createPostRoute({
  path: "/sessions/start",
...
var pauseSessionRoute = createPutRoute({
...
var resumeSessionRoute = createPutRoute({
  path: "/sessions/{id}/resume",
  summary: "Resume a paused session",
  params: sessionIdParam,
  requestSchema: import_zod5.z.object({}),
  responseSchema: sessionSchema,
  tags: ["Sessions"],
  middleware: [authMiddleware],
  operationId: "resumeSession"
});
var completeSessionRoute = createPutRoute({
...
var updateRemainingTimeRoute = createPutRoute({
...
// src/modules/schemas/pomoTask.schema.ts
var import_zod6 = require("zod");
var pomoTaskSchema = import_zod6.z.object({
  Pomo_TaskId: import_zod6.z.number().int().positive(),
  Pomo_Task_Title: import_zod6.z.string(),
  Pomo_Task_Short: import_zod6.z.number().int().nonnegative(),
  Pomo_Task_Long: import_zod6.z.number().int().nonnegative(),
  Pomo_Task_Status: import_zod6.z.boolean(),
  Pomo_Completed_Count: import_zod6.z.number().int().nonnegative(),
  Pomo_Target_Count: import_zod6.z.number().int().nonnegative(),
  SessionId: import_zod6.z.number().int().positive()
});
var pomoTaskProgressSchema = import_zod6.z.object({
  completed: import_zod6.z.number().int().nonnegative(),
  target: import_zod6.z.number().int().nonnegative(),
  isCompleted: import_zod6.z.boolean()
});
var pomoTaskIdParam = import_zod6.z.object({
  Pomo_TaskId: import_zod6.z.coerce.number().int().positive()
});
var sessionIdParam2 = import_zod6.z.object({
  SessionId: import_zod6.z.coerce.number().int().positive()
});
var createTaskSchema2 = import_zod6.z.object({
  sessionId: import_zod6.z.number().int().positive().optional(),
  Pomo_Task_Title: import_zod6.z.string().min(1),
  Pomo_Task_Short: import_zod6.z.number().int().nonnegative().default(5),
  Pomo_Task_Long: import_zod6.z.number().int().nonnegative().default(15),
  Pomo_Target_Count: import_zod6.z.number().int().nonnegative().default(4)
});
var updateTaskSchema2 = import_zod6.z.object({
  Pomo_Task_Title: import_zod6.z.string().min(1).optional(),
  Pomo_Task_Short: import_zod6.z.number().int().nonnegative().optional(),
  Pomo_Task_Long: import_zod6.z.number().int().nonnegative().optional(),
  Pomo_Task_Status: import_zod6.z.boolean().optional(),
  Pomo_Completed_Count: import_zod6.z.number().int().nonnegative().optional(),
  Pomo_Target_Count: import_zod6.z.number().int().nonnegative().optional(),
  SessionId: import_zod6.z.number().int().positive().optional()
});
var assignSessionSchema = import_zod6.z.object({
  sessionId: import_zod6.z.number().int().positive()
});
var completeTaskSchema = import_zod6.z.object({
  Pomo_Task_Status: import_zod6.z.boolean()
});
var setTargetCountSchema = import_zod6.z.object({
  targetCount: import_zod6.z.number().int().nonnegative()
});
var getAllTasksRoute2 = createGetRoute({
  path: "/tasks",
  summary: "Get all tasks for the authenticated user",
  responseSchema: import_zod6.z.array(pomoTaskSchema),
  tags: ["Tasks"],
  middleware: [authMiddleware],
  operationId: "getAllTasks"
});
var getTaskBySessionRoute = createGetRoute({
  path: "/tasks/session/{sessionId}",
  summary: "Get all tasks for a session",
  params: sessionIdParam2,
  responseSchema: import_zod6.z.array(pomoTaskSchema),
  tags: ["Tasks"],
  middleware: [authMiddleware],
  operationId: "getTaskBySession"
});
var getTaskByIdRoute = createGetRoute({
  path: "/tasks/{id}",
...
var getTaskProgressRoute = createGetRoute({
...
var setPomoTargetCountRoute = createPostRoute({
...
var updateTaskRoute2 = createPutRoute({
  path: "/tasks/{id}",
  summary: "Update a pomodoro task",
  params: pomoTaskIdParam,
  requestSchema: updateTaskSchema2,
  responseSchema: pomoTaskSchema,
  tags: ["Tasks"],
  middleware: [authMiddleware],
  operationId: "updateTask"
});
var assignTaskToSessionRoute = createPutRoute({
...
var completeTaskRoute = createPutRoute({
...
var deleteTaskRoute2 = createDeleteRoute({
  path: "/tasks/{id}",
...
// src/modules/models/Pomodoro.model.ts
dotenv5.config();
var prisma4 = new import_prisma5.PrismaClient();

// src/modules/models/PomoTask.model.ts
var dotenv6 = __toESM(require("dotenv"), 1);
var import_prisma6 = __toESM(require_prisma(), 1);
var prisma5 = new import_prisma6.PrismaClient();
dotenv6.config();

// src/modules/services/task.services.ts
var import_prisma7 = __toESM(require_prisma(), 1);
var prisma6 = new import_prisma7.PrismaClient();

// src/modules/controllers/user.controller.ts
var import_prisma8 = __toESM(require_prisma(), 1);
var import_zod7 = require("zod");
var import_jsonwebtoken2 = __toESM(require("jsonwebtoken"), 1);
var import_bcrypt2 = __toESM(require("bcrypt"), 1);
var dotenv8 = __toESM(require("dotenv"), 1);
...
// src/modules/controllers/user.controller.ts
dotenv8.config();
var prisma7 = new import_prisma8.PrismaClient();
var userSchema3 = import_zod7.z.object({
  email: import_zod7.z.string().email(),
  password: import_zod7.z.string().min(7)
});

// src/modules/middlewares/Task.validators.ts
var import_zod8 = require("zod");
var TaskSchema = import_zod8.z.object({
  Task_Title: import_zod8.z.string().min(1, "Title is required"),
  Task_Description: import_zod8.z.string().nullable().optional(),
  Task_Start_Date: import_zod8.z.string().optional(),
  Task_End_Date: import_zod8.z.string().optional(),
  Task_Status: import_zod8.z.enum(["Incomplete", "Completed"]).optional(),
  Task_Color: import_zod8.z.string().optional(),
  Task_Icon: import_zod8.z.string().nullable().optional(),
  Task_Start_Time: import_zod8.z.string().optional(),
  Task_End_Time: import_zod8.z.string().optional()
});
var taskUpdateSchema = TaskSchema.partial();
...
// src/modules/middlewares/error.ts
function errorHandler(err, c) {
  if (err instanceof BaseError) {
    return c.json(err.toJSON(), err.statusCode);
  }
  const internalError = new InternalServerError(
    env_default.nodeEnv === "development" ? err.message : "Something went wrong"
  );
...
var db = new import_prisma9.PrismaClient();
app.onError(errorHandler);
app.use(
  (0, import_cors.cors)({
    origin: (origin) => {
      if (env_default.isProduction) {
      }
